...
export default function NewPost() {
  ...
  const handleSubmit = () => {
    if (!form.enTitle) return;
    // Serbian columns are NOT NULL, so mirror English until a translation is entered.
    createPost.mutate({
      ...form,
      rsTitle: form.enTitle,
      rsSubtitle: form.enSubtitle,
      rsCollection: form.enCollection,
      rsContent: form.enContent,
      rsDetailContent: form.enDetailContent,
      sortOrder: 0,
    });
  };

  const t = {
    rs: { title: "Novi tekst", back: "Nazad", submit: "Objavi", submitting: "Objavljujem...", required: "Naslov je obavezan" },
      ...
      <div className="mx-auto" style={{ maxWidth: "680px", padding: "80px 24px 80px" }}>
        ...
        <div className="space-y-4">
          ...
          <div style={{ borderTop: "1px solid var(--border-light)", paddingTop: "16px" }}>
            <h3 style={{ fontSize: "12px", color: "var(--text-grey)", marginBottom: "12px" }}>Content</h3>
