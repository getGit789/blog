...
const t = {
  rs: {
    title: "Ostavi poruku",
    nameLabel: "Tvoje ime (opciono)",
    namePlaceholder: "Anonimno",
    messageLabel: "Tvoja poruka",
    messagePlaceholder: "Napiši šta želiš da kažeš...",
    cancel: "Otkaži",
    send: "Pošalji",
    sent: "Poruka je poslata!",
    sending: "Šaljem...",
    error: "Slanje nije uspelo, pokušaj ponovo",
    emptyMessage: "Unesi poruku",
    viewGuestbook: "Pogledaj knjigu gostiju →",
  },
  en: {
